...
import br.edu.ifpb.autenticador.autenticador.permissoes.*;
...
public class UserService {
    ...
    public void updateUserPermission(Long userId, String permissionName) {
        ...
        switch (permissionName) {
            case "administrador":
                permission = new Administrador().permission;
                break;
            case "somenteLeitura":
                permission = new SomenteLeitura().permission;
                break;
            case "operador":
                permission = new Operador().permission;
                break;
            default:
                permission = new PermisaoDefault().permission;
        }
